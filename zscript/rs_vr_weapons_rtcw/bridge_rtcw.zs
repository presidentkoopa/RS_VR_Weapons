...
class RTCW_Bridge : WM_SetBridge
{
	...
	override void Configure()
	{
		...
		Swap("Pistol",         "RT_Luger");
		Swap("Chaingun",       "RT_MG42");
		Swap("PlasmaRifle",    "RT_StG44");
		Swap("BFG9000",        "RT_Browning");
		...
		Swap("RocketLauncher", "RT_BAR");
		Swap("Chainsaw",       "RT_Mosin");   // no melee in the set; the bolt rifle is the prize
